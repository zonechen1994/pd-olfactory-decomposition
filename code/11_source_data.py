...
flow = pd.DataFrame([dict(box='Training cohort', n=1398, detail='PD 1,163 + HC 235'),
                     ...
                     dict(box='Correlation analyses (OIS and UPSIT both present)', n=2441, detail=''),
                     dict(box='After excluding prevalent Parkinson\'s disease at baseline', n=2375, detail='excluded 78'),
