...
| 5a | Sources of data for development and evaluation, rationale, representativeness | Methods, Data sources and measurements. Methods, Model fitting, for why the training set is Parkinson's disease plus controls. Representativeness in Discussion, limitations |
| 5b | Dates of participant data, accrual, end of follow-up | Methods, Data sources and measurements. Baseline visits July 2010 to December 2025, prodromal accrual from July 2013, latest visit December 2025, data cut 23 February 2026 |
| 6a | Setting, number and location of centres | Methods, Data sources and measurements. 44 PPMI centres in North America and Europe |
...
| 7 | Data pre-processing and quality checking | Methods, Data sources and measurements (scan selection, tracer, missing binding ratios, complete-case rule) and Methods, Model fitting (standardisation) |
...
| 9a | Choice of initial predictors and any pre-selection | Methods, Model fitting. All 33 released binding ratios plus age, sex and years of education, with no pre-selection |
| 9b | Definition and measurement of predictors | Methods, Data sources and measurements |
| 9c | Qualifications of predictor assessors | Methods, Data sources and measurements. Central quantification by the PPMI imaging core laboratory [PMID 30564614] |
...
| 11 | Handling of missing data, reasons for omissions | Methods, Data sources and measurements (complete case, UPSIT item imputation rule) and Participant flow and follow-up (stepwise exclusions with counts) |
| 12a | How data were used, partitioning | Methods, Model fitting and Statistical analysis. Development in 1,398 participants, five-fold internal cross-validation, leave-one-centre-out over 44 centres, then unchanged application to 1,759 prodromal participants |
| 12b | Handling of predictors, rescaling, transformation | Methods, Model fitting. Standardised on the training set, the fitted scaler applied unchanged elsewhere |
| 12c | Model type, rationale, building steps, hyperparameter tuning, internal validation | Methods, Model fitting. Ridge, penalty fixed at 1.0 and not tuned, chosen among six families compared under the same five-fold cross-validation (Supplementary Table 1) |
| 12d | Heterogeneity across clusters | Methods, Model validation. Leave-one-centre-out across all 44 centres (Fig. 2b, Supplementary Table 1) and a discovery against external centre split, whose inconsistency is reported |
...
| 12f | Model updating or recalibration | Methods, Model fitting. **None performed** in either cohort |
| 12g | How predictions were calculated for evaluation | Methods, Model fitting, and Code availability. Fitted coefficients and standardisation parameters are released |
...
| 15 | Model output, classification and thresholds | Methods, Model fitting, and Results, risk stratification. Output is a continuous score in UPSIT points. Cut points are reported as exploratory and are not proposed as clinical thresholds |
...
| 18f | Availability of analytical code | Code availability. https://github.com/zonechen1994/pd-olfactory-decomposition |
...
| 22 | Full model available for prediction in new individuals | Code availability. Coefficients, standardisation parameters and the fitted object are in the released repository |
...
| 26 | Limitations and their effects | Discussion, final two paragraphs. Proportional hazards checked by Schoenfeld residuals (Supplementary Table 11) |
